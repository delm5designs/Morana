...
// slides/DeckSlides.jsx
try { (() => {
/* Morana slide library. The deck is the dark counterpart to the cream website:
   covers, dividers and the close sit on ink; working slides sit on cream.
   Every slide is authored at 1280x720 (the pull quote at 720x720). */
...
/* Cover: ink ground, cream rings turning behind the title. */
function TitleSlide({
  title = "Every spring starts with a",
  accent = "winter",
  eyebrow = "Metalearning consultancy",
  presenter = "Morana \u00B7 2026",
  style
}) {
  return /*#__PURE__*/React.createElement("div", {
    style: Object.assign({}, SLIDE, {
      background: "var(--surface-inverse)",
      color: "var(--text-on-dark)",
      justifyContent: "center",
      padding: PAD
  ...
  }, /*#__PURE__*/React.createElement(__ds_scope.RingMark, {
    size: "100%",
    rings: 4,
    animated: true,
    nodes: true,
...
/* Divider: ink ground, big number, ring progress. */
function SectionSlide({
  number = "02",
  title = "Unlearn",
  lead = "Naming the habits that stopped paying rent.",
  completed = 2,
  style
}) {
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, lead))), /*#__PURE__*/React.createElement(Footline, {
    inverse: true
  }, number, " / 03"));
}

/* Statement: cream ground, one line, nothing else. */
function StatementSlide({
  line = "Most people were never taught how to learn. They were taught",
  accent = "subjects",
  style
}) {
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, line, " ", /*#__PURE__*/React.createElement("em", {
    style: {
      fontStyle: "italic",
      color: "var(--text-reflective)"
    }
  }, accent), "."), /*#__PURE__*/React.createElement(Footline, null, "Approach"));
}

/* Comparison: two columns, hairline between. */
function ComparisonSlide({
  eyebrow = "The gap",
  title = "Two ways to spend a training budget",
  left = {
    label: "What usually happens",
    items: ["A course is bought and half-watched.", "Notes are reread until they feel familiar.", "Confidence rises; recall does not.", "Nobody owns the method afterwards."]
  },
  right = {
    label: "What we do instead",
    items: ["We audit where learning time actually goes.", "Practice is made deliberately harder.", "Recall is tested, not assumed.", "Your managers run the method without us."]
  },
  style
}) {
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, [left, null, right].map((col, i) => col === null ? /*#__PURE__*/React.createElement("div", {
    key: "rule",
    style: {
    ...
    style: {
      ...
      letterSpacing: "0.14em",
      textTransform: "uppercase",
      color: i === 0 ? "var(--text-muted)" : "var(--text-accent)",
      marginBottom: 28
    }
  }, col.label), /*#__PURE__*/React.createElement("ul", {
    style: {
      margin: 0,
      padding: 0,
      listStyle: "none",
  ...
  }, col.items.map((t, n) => /*#__PURE__*/React.createElement("li", {
    key: n,
    style: {
      display: "flex",
      gap: 16,
      fontSize: 21,
      lineHeight: 1.45,
      color: i === 0 ? "var(--text-muted)" : "var(--text-body)"
    }
  }, /*#__PURE__*/React.createElement("span", {
    style: {
      flex: "none",
      ...
      borderRadius: "50%",
      marginTop: 11,
      background: i === 0 ? "var(--border-strong)" : "var(--olive-600)"
    }
  }), /*#__PURE__*/React.createElement("span", null, t))))))), /*#__PURE__*/React.createElement(Footline, null, "Pitch"));
}

/* Process: the three steps as ring progress. */
function ProcessSlide({
  eyebrow = "How it works",
  title = "Audit, unlearn, rebuild",
  steps = [{
    n: "01",
    name: "Audit",
    body: "We map how learning actually happens - not how the org chart says it does."
  }, {
    n: "02",
    name: "Unlearn",
  ...
  }, s.body)))), /*#__PURE__*/React.createElement(Footline, null, "Approach"));
}

/* Program overview: the sellable offerings, no prices. */
function ProgramSlide({
  ...
  rows = [{
    ...
    name: "Project",
    duration: "6-12 weeks",
    body: "A custom program built around one goal your team already has."
  }, {
    track: "company",
    name: "Workshop",
    duration: "One or two days",
    body: "A practical session on how learning works and where time leaks."
  }, {
    track: "individual",
    name: "Short Intensive",
    duration: "6-8 weeks",
    body: "One-to-one work on how you learn, aimed at a goal you name."
  }],
  note = "Scoped and quoted per engagement. There is no price list.",
  style
}) {
  return /*#__PURE__*/React.createElement("div", {
    style: Object.assign({}, SLIDE, {
    ...
    style: {
      display: "grid",
      gridTemplateColumns: "150px 260px 1fr 180px",
      gap: 32,
      alignItems: "baseline",
      padding: "26px 0",
    ...
    tone: r.track
  }, r.track === "company" ? "Company" : "Individual"), /*#__PURE__*/React.createElement("h3", {
    style: {
      margin: 0,
      fontFamily: "var(--font-display)",
      fontWeight: 400,
  ...
  }, r.duration)))), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: "40px 0 0",
      paddingTop: 24,
      borderTop: "1px solid var(--border-subtle)",
  ...
  }, note), /*#__PURE__*/React.createElement(Footline, null, "Pitch"));
}

/* Close: ink ground, the ask and the address. */
function ClosingSlide({
  ...
  }, accent), "."), /*#__PURE__*/React.createElement("a", {
    href: "mailto:" + email,
    style: {
      display: "inline-block",
      marginTop: 40,
...
/* Square pull quote for social. */
function QuoteSquare({
...
Object.assign(__ds_scope, { TitleSlide, SectionSlide, StatementSlide, ComparisonSlide, ProcessSlide, ProgramSlide, ClosingSlide, QuoteSquare });
})(); } catch (e) { __ds_ns.__errors.push({ path: "slides/DeckSlides.jsx", error: String((e && e.message) || e) }); }
...
__ds_ns.ComparisonSlide = __ds_scope.ComparisonSlide;

__ds_ns.ProcessSlide = __ds_scope.ProcessSlide;

__ds_ns.ProgramSlide = __ds_scope.ProgramSlide;

__ds_ns.ClosingSlide = __ds_scope.ClosingSlide;

__ds_ns.QuoteSquare = __ds_scope.QuoteSquare;
